...
int board_size_width = 32;  //盤面の大きさ
int board_size_height = 32;
int MOVE = 1;
...
void random_finish_board(int num[3]){
    int random;
    int shuffle1[2] ={0};
    int shuffle2[2] ={0};
...
int main(){
    ...
    random_finish_board(used_num);  //最終状態を生成する
    ...
    cout << elapsed / 1000 << "ms" << endl << endl;
    //ここまで


    //プレイ開始
    cout << endl <<"かみやまひらがなこうせんは　たまねぎを　はなった！" << endl;
    cout << "＞＞「くらえッ！タマネギ！」" <<endl;
