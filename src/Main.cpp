...
*/
	...
	while (System::Update()){
        ...
        font(U"NOW").draw(30, 20, ColorF{ 1.0, 1.0, 1.0 });
        Board_draw(40, 70, side_length, board_now, font);

        font(U"FINISH").draw(BOARD_WIDTH * side_length + 80, 20, ColorF{ 1.0, 1.0, 1.0 });
        Board_draw(80 + BOARD_WIDTH * side_length, 70, side_length, board_finish, font);
        ...
        */
        ...
        Rect{40, 70, side_length * sort_result.first.second, side_length * sort_result.first.first}.drawFrame(0.8, 0.8, Palette::Green);
        Rect{40, 70 + side_length * sort_result.first.first, side_length * sort_result.second.second, side_length * (sort_result.second.first - sort_result.first.first)}.drawFrame(0.8, 0.8, Palette::Green);
